			...
			<div className="w-full max-w-[1100px] flex justify-between items-center mt-20 mx-auto">
				<div className="max-w-[640px]">
					...
					<p className="mt-4 text-gray-200 leading-relaxed">
						Em apenas uma semana você vai dominar na prática umas das tecnologias mais utilizadas
						e com alta demanda pra acessar as melhores oportunidades do mercado.
					</p>
				</div>
